...
def analysis_main(data, columns, label=None, categorical_features=None, num_features=None):
    ## 所有特征的分析
    print('##################################################################################')
    print('###################################处理所有特征###################################')
    print('##################################################################################')
    analysis_all_features = dataAnalysis.Analysis_all_features(data, columns, label)
    ...
    if not categorical_features:
        ...
        analysis_categorical_features = dataAnalysis.Analysis_categorical_features(data, categorical_features, label)
    ...
    if not num_features:
        ...
        analysis_numeric_features = dataAnalysis.Analysis_numeric_features(data, num_features, label)
