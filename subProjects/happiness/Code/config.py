...
class ParamConfig:
    def __init__(self, mark, mark_text='', cleanMarkData=False):
        ...
        """
        # data params
        self.project_name = 'happiness'
        self.train_file = '/happiness_train_complete.csv'
        self.test_file = '/happiness_test_complete.csv'
        self.index_rfg = '[happiness_ori]'
        self.data_label = 'happiness'
        self.n_classes = 4
        self.mark = mark
